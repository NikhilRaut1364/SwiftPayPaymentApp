...
<body>
<form action="flightPayment.jsp" method="POST">
<div class="header">
	<div class="plane">
...
<div class="parent">
	<div class="child">
		<img src="images java/flight.gif" height="500" width="600">
	</div>
	<div class="child1">
		<h1 style="margin-bottom:15px;font-size:30px;color:#666666;">Book Your Ticket</h1>
			...
			<tr>
				<td><center>
					...
					<select name="fclass" style="height:35px;width:200px;font-size:20px;border:none;border-bottom:2px solid #25488e;">
						...
						<option value="Peconomy">Premium Economy</option>
