...
<body>
<form action="Justice" method="POST">
...
Cookie cookie19=new Cookie("ltheater",theater+"");
Cookie cookie20=new Cookie("ltime",time+"");
Cookie cookie21=new Cookie("lmdate",mdate+"");
...
try{
	...
	ResultSet rs=stmt.executeQuery("select * from justice where theater='"+theater+"' and time='"+time+"' and mdate='"+mdate+"'");
	while(rs.next())
	{
...
<div class="abstract">
	...
	<div class="poster">
		<img src="images java/justiceleague.jpg" height="350" width="300">
	</div>
</div>
<div class="parent">
	<div class="synopsis">
		<h1 style="margin-bottom:15px;font-size:30px;color:black;">Justice League</h1>
	</div>
	<div class="child">
		<div class="seatname">
