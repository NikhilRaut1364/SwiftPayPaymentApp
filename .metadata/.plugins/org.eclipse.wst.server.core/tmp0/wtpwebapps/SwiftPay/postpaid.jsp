...
<body>
<form action="postpaidPayment.jsp" method="POST">
	<div class="header">
		<div class="plane">
	...
	<div class="parent">
		<div class="child1">
		<h1 style="margin-bottom:15px;font-size:30px;color:#666666;">PostPaid</h1>
			<table height="350" width="400">
				<tr>
					<td><center><input type="text" autocomplete="off" name="phno" placeholder="Contact Number" style="height:35px;width:300px;font-size:20px;border:none;border-bottom:2px solid #25488e;"></center></td>
				</tr>
				<tr>
					<td><center><span style="font-size:20px;">Service Provider</span>
		...
		<div class="child2">
			<img src="images java/mob.gif" height="500" width="600">
		</div>
	</div>
</form>
</body>
