...
<html>
<head>
<title>Activity:Pawna Lake Camping</title>
<style>
*{
margin:0px;
font-family:candara;
...
<body>
<form action="activity2.html" method="POST">
<div class="header">
	<div class="plane">
...
<div class="abstract">
	...
	<div class="poster">
		<img src="images java/eventsactivities.jpg" height="350" width="300">
	</div>
</div>
<div class="parent">
	<div class="synopsis">
		<h1 style="margin-bottom:15px;font-size:60px;color:black;">Activity:Pawna Lake Camping</h1>
	</div>
