...
<html>
<head>
	<title>BechDe Transaction Report</title>
<style type="text/css">
*{
margin:0px;
font-family:candara;
...
<div class="parent">
	<div class="child">
		<h1 style="margin-bottom:15px;margin-top:20px;font-size:30px;color:#666666;">BechDe TRANSACTION REPORT</h1>
		<table width="1200">
...
<%
	...
	Connection con=null;
	String url="jdbc:ucanaccess://E://Database//olx.accdb";
	try{
