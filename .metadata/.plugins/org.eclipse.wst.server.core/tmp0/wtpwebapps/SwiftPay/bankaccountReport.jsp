...
<div class="parent">
	<div class="child">
		<h1 style="margin-bottom:15px;margin-top:20px;font-size:30px;color:#666666;">BANK ACCOUNT REPORT</h1>
		<table width="1200">
		
			<tr>
				<th style="font-size:20px;"><center>ACCNO</center></th>
				<th style="font-size:20px;"><center>NAME</center></th>
				<th style="font-size:20px;"><center>IFSC</center></th>
				<th style="font-size:20px;"><center>BALANCE</center></th>
			</tr>
...
<%
	...
	try{
		...
		Statement stmt = con.createStatement();		
			ResultSet rs2=stmt.executeQuery("select * from bankaccount");
				while(rs2.next())
				{
%>
			...
			<tr>
				<td style="font-size:20px;"><center><%out.println(rs2.getString("accno")); %></center></td>
				<td style="font-size:20px;"><center><%out.println(rs2.getString("name")); %></center></td>
				<td style="font-size:20px;"><center><%out.println(rs2.getString("ifsc")); %></center></td>
				<td style="font-size:20px;"><center><%out.println(rs2.getInt("balance")); %></center></td>
			</tr>
