...
<body>
<form action="Jumanji" method="POST">
...
Cookie cookie13=new Cookie("jtheater",theater+"");
Cookie cookie14=new Cookie("jtime",time+"");
Cookie cookie15=new Cookie("jmdate",mdate+"");
...
try{
	...
	ResultSet rs=stmt.executeQuery("select * from jumanji where theater='"+theater+"' and time='"+time+"' and mdate='"+mdate+"'");
	while(rs.next())
	{
...
<div class="abstract">
	...
	<div class="poster">
		<img src="images java/jumanji.jpg" height="350" width="300">
	</div>
</div>
<div class="parent">
	<div class="synopsis">
		<h1 style="margin-bottom:15px;font-size:30px;color:black;">Jumanji: Welcome To The Jungle</h1>
	</div>
	<div class="child">
		<div class="seatname">
		...
		<div class="seat">
			...
			<table height="130" width="800">
				...
				<tr>
					...
					<td><center><%if(sc2.equals("notbooked")){ %><input type="checkbox" class="test" name="C2" value="C2" id="C2" onclick="display(this.id);"><%}else{ %><input type="checkbox" class="test" name="C2" value="C2" id="C2" disabled><%} %><br><span>C2</span></center></td>
