...
<div class="parent">
	<div class="child1">
		<h1 style="margin-bottom:15px;font-size:30px;color:#666666;">Electricity</h1>
		<table style="height:400px;width:500px;">
			...
			<tr>
				<td><center><input type="text" autocomplete="off" name="scode" placeholder="Sub-Division Code" style="height:35px;width:300px;font-size:20px;border:none;border-bottom:2px solid #25488e;"></center></td>
			</tr>
			<tr>
				<td><center>
				...
				<select name="provider" style="height:35px;width:160px;font-size:20px;border:none;border-bottom:2px solid #25488e;">
					<option value="MSEDC">MSEDC</option>
	...
	<div class="child2">
		<img src="images java/electricity1.gif" height="500" width="600">
	</div>
</div>
</form>
</body>
