...
<div class="parent">
	<div class="child">
		<h1 style="margin-bottom:15px;margin-top:20px;font-size:30px;color:#666666;">TRANSACTION REPORT</h1>
		<table width="1200">
		
			<tr>
				<th style="font-size:20px;"><center>TID</center></th>
				<th style="font-size:20px;"><center>UNAME</center></th>
				<th style="font-size:20px;"><center>TNAME</center></th>
				<th style="font-size:20px;"><center>TDATE</center></th>
				<th style="font-size:20px;"><center>PMETHOD</center></th>
...
%>
			...
			<tr>
				...
				<td style="font-size:20px;"><center><%out.println(rs2.getString("uname")); %></center></td>
				<td style="font-size:20px;"><center><%out.println(rs2.getString("tname")); %></center></td>
				<td style="font-size:20px;"><center><%out.println(rs2.getString("tdate")); %></center></td>
				<td style="font-size:20px;"><center><%out.println(rs2.getString("pmethod")); %></center></td>
