...
Cookie cookie22=new Cookie("traveller",traveller+"");
...
try{
	...
	ResultSet rs=stmt.executeQuery("select * from flight where source='"+from+"' and destination='"+to+"' and fdate='"+fdate+"' and class='"+fclass+"'");
	while(rs.next())
	{
		f=rs.getString("source");
		t=rs.getString("destination");
		fda=rs.getString("fdate");
	...
	if(from.equals(f) && to.equals(t) && fdate.equals(fda) && fclass.equals(fc))
	{
		...
		else if(fclass.equals("Peconomy"))
		{
			int amt=2500;
			tot=amt*traveller;
		}
...
<div class="parent">
	<div class="child">
	<h1 style="margin-bottom:15px;font-size:30px;color:#666666;">Flight Payment</h1>
