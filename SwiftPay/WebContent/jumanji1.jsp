...
<body>
<form action="jumanji2.jsp" method="POST">
<div class="header">
	<div class="plane">
		...
		<div class="child-1">
			...
			<table height="350" width="400">
				...
				<tr>
					...
					<input type="date" min="2020-09-19" name="mdate" style="height:35px;font-size:20px;border:none;border-bottom:2px solid #25488e;">
					</center></td>
				</tr>
				<tr>
					<td><center>
