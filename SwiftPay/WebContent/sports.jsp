...
<html>
<head>
<title>Sports:Pune Half-Marathon</title>
<style>
*{
margin:0px;
font-family:candara;
...
<body>
<form action="sportPayment.jsp" method="POST">
<div class="header">
	<div class="plane">
...
<div class="abstract">
	...
	<div class="poster">
		<img src="images java/eventssports.jpg" height="350" width="300">
	</div>
</div>
<div class="parent">
	<div class="synopsis">
		<h1 style="margin-bottom:15px;font-size:60px;color:black;">Sports:Pune Half-Marathon</h1>
	</div>
