...
<html>
<head>
<title>Events:Pune Comedy Festival</title>
<style>
*{
margin:0px;
font-family:candara;
...
<body>
<form action="comedyPayment.jsp" method="POST">
<div class="header">
	<div class="plane">
...
<div class="abstract">
	...
	<div class="poster">
		<img src="images java/events.jpg" height="350" width="300">
	</div>
</div>
<div class="parent">
	<div class="synopsis">
		<h1 style="margin-bottom:15px;font-size:60px;color:black;">Pune Comedy Festival</h1>
	</div>
		...
		<div class="child-1">
			...
			<table height="350" width="400">
				<tr>
					...
					<input type="date" name="edate" min="2020-09-19" style="height:35px;font-size:20px;border:none;border-bottom:2px solid #25488e;">
					</center></td>
				</tr>
				<tr>
					<td><center>
