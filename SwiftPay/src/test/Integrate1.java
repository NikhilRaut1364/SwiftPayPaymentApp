...
public class Integrate1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String url1="jdbc:ucanaccess://E://Database//heritage.accdb";
		try {
			...
			if(rad.equals("debit"))
			{
				...
				if(dcardno.equals(dcno) && dcv.equals(dcv))
				{
					...
					else
					{
						...
						response.sendRedirect("https://f7dbe453b0f9.ngrok.io/Heritage/Sucessfully.jsp?amount="+amount+"");
					}
				}
				else
				{
